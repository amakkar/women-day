...
<html>
   ...
   <body>
               ...
               <div class="col-md-8">
                  ...
                  <div class="right">
                     <ul class="list-unstyled">
                        <li class="a text-left"><a href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a> </li>
      ...
      <!-- Cook or sell div -->
      <div class="row">
      	<div class="col-md-6 col-md-offset-3" style="padding:2% 0%" align="center">
      		<button class='btn btn-lg'>Cook Food</button>
      		<a href="http://example.com" class="round-button">OR</a>
      		<button class='btn btn-success'>Buy Food</button>
      	</div>
      </div>
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="images-slider">
               <div id="fwslider">
                  <div class="slider_container">
                     <div class="slide">
                        <img src="resources/images/home-bg2.jpg" alt="" height="700px"/>
                     ...
                     <div class="slider_container">
                        <div class="slide">
                           <img src="resources/images/home-bg.jpg" alt="" height="700px"/>
                           <div class="slide_content">
                              <div class="slide_content_wrap">
                                 <p class="description">Taste Bhi, Health Bhi!</p>
                                 <h4 class="title">Home Cooked Food</h4>
                     ...
                     <div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
                        <div class="portfolio-wrapper">
                           <a data-toggle="modal" data-target=".bs-example-modal-md" href="#" class="b-link-stripe b-animate-go  thickbox">
                              <img src="resources/images/cont1.jpg" />
                              <div class="b-wrapper">
                                 <h2 class="b-animate b-from-left    b-delay03 "><img src="resources/images/link-ico.png" alt=""/></h2>
                              </div>
                           </a>
                        </div>
                     </div>
               ...
               <div class="col-md-2">
                  <div class="grid">
                     <div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
                        <div class="portfolio-wrapper">
                           <a data-toggle="modal" data-target=".bs-example-modal-md" href="#" class="b-link-stripe b-animate-go  thickbox">
                              <img src="resources/images/cont2.jpg" />
                              <div class="b-wrapper">
                                 <h2 class="b-animate b-from-left    b-delay03 "><img src="resources/images/link-ico.png" alt=""/></h2>
                              </div>
                           </a>
               ...
               <div class="col-md-2">
                  <div class="grid">
                     <div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
                        <div class="portfolio-wrapper">
                           <a data-toggle="modal" data-target=".bs-example-modal-md" href="#" class="b-link-stripe b-animate-go  thickbox">
                              <img src="resources/images/cont3.jpg" />
                              <div class="b-wrapper">
                                 <h2 class="b-animate b-from-left    b-delay03 "><img src="resources/images/link-ico.png" alt=""/></h2>
                              </div>
                           </a>
               ...
               <div class="col-md-2">
                  <div class="grid">
                     <div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
                        <div class="portfolio-wrapper">
                           <a data-toggle="modal" data-target=".bs-example-modal-md" href="#" class="b-link-stripe b-animate-go  thickbox">
                              <img src="resources/images/cont4.jpg" />
                              <div class="b-wrapper">
                                 <h2 class="b-animate b-from-left    b-delay03 "><img src="resources/images/link-ico.png" alt=""/></h2>
                              </div>
                           </a>
